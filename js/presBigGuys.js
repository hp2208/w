...
function addEventsForChildrenOfBigGuy() {
  ...
  happouDivsTextContentCache = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;

  inputHappouDivs[0].addEventListener("keyup", () => {
    let happouDivsTextContent = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;
  ...
  inputHappouDivs[1].addEventListener("keyup", () => {
    let happouDivsTextContent = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;
    if(happouDivsTextContent!==happouDivsTextContentCache) {
      //Clear inputCache
      inputCache.value = '';
  ...
  inputHappouDivs[2].addEventListener("keyup", () => {
    let happouDivsTextContent = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;
    if(happouDivsTextContent!==happouDivsTextContentCache) {
      //Clear inputCache
      inputCache.value = '';
  ...
  inputHappouDivs[1].addEventListener("click", () => {
    let happouDivsTextContent = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;
    if(happouDivsTextContent!==happouDivsTextContentCache) {
      //Clear inputCache
      inputCache.value = '';
  ...
  inputHappouDivs[2].addEventListener("click", () => {
    let happouDivsTextContent = inputHappouDivs[0].innerHTML + inputHappouDivs[1].innerHTML + inputHappouDivs[2].innerHTML;
    if(happouDivsTextContent!==happouDivsTextContentCache) {
      //Clear inputCache
      inputCache.value = '';
  ...
  inputHappouDivs[1].addEventListener("scroll", () => {
    typeOfHappouDivs[1].scrollTop = inputHappouDivs[1].scrollTop;
    //tooltipbouyActivate();
  });
  typeOfHappouDivs[1].addEventListener("scroll", () => {
    inputHappouDivs[1].scrollTop = typeOfHappouDivs[1].scrollTop;
    //tooltipbouyActivate();
  });

  inputHappouDivs[2].addEventListener("scroll", () => {
    typeOfHappouDivs[2].scrollTop = inputHappouDivs[2].scrollTop;
    //tooltipbouyActivate();
  });
  typeOfHappouDivs[2].addEventListener("scroll", () => {
    inputHappouDivs[2].scrollTop = typeOfHappouDivs[2].scrollTop;
    //tooltipbouyActivate();
  });
...
function tooltipbouyActivate() {
  ...
  for (let i = 0; i < tooltipbouyPres.length; i++) {
    ...
    if (range.intersectsNode(tooltipbouyPre)) {
      ...
      //tooltiptextSpan.style.top = tooltipbouyPre.getBoundingClientRect().top.toFixed() + 'px';
      //console.log(tooltipbouyPre.getBoundingClientRect().top.toFixed() + 'px');
    } else {
